...
async function seed() {
  ...
  await upsert({
    ...
    seo: {
      ...
      metaDescription: "Railshop is a boutique digital growth agency for home and consumer service businesses. We build websites, run paid ads, and drive SEO. Delivered by senior practitioners with national brand experience.",
    },
    hero: {
    ...
    aboutTeaser: {
      ...
      cards: [
        { _key: key(), eyebrow: '01', heading: 'Senior-Only Team',            body: 'Every engagement is led by us directly. Senior work start to finish, not handed down the line.' },
        { _key: key(), eyebrow: '02', heading: 'The Right People, Every Time', body: 'When a project needs a specialist, we know exactly who to call and why.' },
        { _key: key(), eyebrow: '03', heading: 'Built to Partner',             body: "We're built for long-term partnerships where each program builds on the last." },
      ],
    },
    blogTeaser: {
      title: 'Straight talk on digital marketing.',
      intro: "Written by practitioners running live campaigns. What's working, what's changed, and what to ignore.",
    },
    proofStats: [
  ...
  await upsert({
    ...
    seo: {
      ...
      metaDescription: 'Railshop is a boutique performance marketing agency. Senior practitioners, direct client relationships, no hand-offs.',
    },
    hero: {
      eyebrow: '// About',
    ...
    valuesSection: {
      ...
      heading: 'How we work.',
      values: [
        { _key: key(), eyebrow: '01', heading: 'Honest Reporting',      body: "You'll always know what's working and what isn't. Real metrics, plain language." },
  ...
  await upsert({
    ...
    approach: {
      ...
      sub: 'Every engagement follows the same principle: find what works, build on it, and grow.',
    },
    ctaBanner: {
      title: 'Not sure where to start?',
      subtitle: "Most clients begin with a 30-minute call. We'll tell you exactly where we'd focus first. Come with questions. Leave with a clear picture.",
    },
  });
  ...
  const services = [
    ...
    },
    {
      ...
      ctaHeadline: 'Ready to build organic visibility that keeps growing?',
    },
    {
    ...
    },
    {
      ...
      approach: [
        ...
        { _key: key(), step: 'Prioritisation',     detail: 'We identify the highest-impact opportunities and sequence them based on your goals and resources.' },
  ...
  const caseStudies = [
    {
      ...
      excerpt: "A family-owned HVAC business stuck on word-of-mouth and slow seasons. We built their full digital program and grew with them for five years.",
      homepagePullQuote: 'From local HVAC company to regional market leader.',
      homepageBody: "A family-owned HVAC business ready to scale but stuck on word-of-mouth and slow seasons. We built their full digital program and grew with them for five years. The result: 4x revenue growth and an 8x blended return on ad spend.",
      stats: [
    ...
    },
    {
      ...
      challenge: "The company had built a strong reputation through word-of-mouth over eight years but had never invested in digital. They had no website, no Google Business Profile, and were not showing up for any local search terms. A slow spring booking period prompted the owner to look at what competitors were doing online. The gap was significant. They needed to build their entire digital presence from scratch, quickly, before the peak season.",
      approach: [
    ...
    },
    {
      ...
      excerpt: "An excavation contractor relying entirely on referrals with no digital presence. We built their brand online and opened a new inbound lead channel.",
      ...
      challenge: "The contractor had a strong reputation locally but zero online presence. No website, no Google listing, nothing. All work came through word-of-mouth and relationships with general contractors. The owner wanted to diversify lead sources and reduce dependence on any single referral network. The challenge was that excavation is a low-volume, high-value category. Quality mattered more than volume, and the website and ads needed to filter for the right types of projects.",
      approach: [
      ...
      testimonial: {
        quote: "We had never gotten a lead from the internet in 12 years of business. Now we get inbound enquiries every week from people we've never met. The quality is good too. Real projects, not tire-kickers.",
        name: 'Owner',
  ...
  await upsert({
    ...
    bio: "VP of Product at Momentive Software, where he leads product development and ships complex software systems. Sean brings that same discipline to every Railshop engagement, making sure strategy translates into execution that actually ships.",
  ...
  const posts = [
    ...
    },
    {
      ...
      body: [
        ...
        h2('What Still Works'),
        p("Google Business Profile remains the single highest-leverage local SEO asset for service businesses. A well-managed profile (complete information, regular photo updates, a consistent review stream, and active Q&A management) still drives significant call volume directly."),
    ...
    },
    {
      ...
      body: [
        p("Most service business websites are not doing the job they were designed to do. They look fine. They load. They have a phone number somewhere on the page. But they do not convert at the rate they should, given the traffic they receive."),
  ...
  await upsert({
    ...
    nextSteps: {
      steps: [
        ...
        { _key: key(), title: "We talk (if it's a fit)",   body: "If it makes sense, we'll set up a quick call. No agenda, no sell. Just a straight conversation about what you're building.",                 statusLabel: 'Pending'     },
      ],
    },
    ctaCard: {
